...
import {
  ...
  Resources,
  BlogCTA,
} from "@/features/(marketing)/blog";
import ROUTES from "@/lib/routes";
>>>>>>> 0d3d65ddb422d4f6abece8f70a1f6cd48635b63d
...
>>>>>>> 0d3d65ddb422d4f6abece8f70a1f6cd48635b63d
      ...
      <FeaturedPost
        ...
        post={{
          title:
            "How AI-Powered Attendance Systems Are Reducing Truancy by 40% in K-12 Schools",
          excerpt:
          ...
          image:
            "https://decibel360cloud.com/ae/wp-content/uploads/2025/02/ezgif.com-gif-maker-6.webp",
...
=======
      ...
      <PostGrid
        ...
        posts={[
          {
            title:
              "5 Strategies to Streamline Fee Collection and Reduce Defaults by 60%",
            excerpt:
            ...
            image:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMjbDetvzmQoHDLKS0qZuFbOO4hphBLa1y5Q&s",
          ...
          {
            title:
              "Building a Data-Driven Culture: How Principals Use Dashboards to Boost Student Outcomes",
            excerpt:
            ...
            image:
              "https://appinventiv.com/wp-content/uploads/2022/06/benefits-to-having-a-data-driven-culture-scaled.webp",
          ...
          {
            title:
              "The Complete Guide to Digital Report Cards: From Setup to Parent Delivery",
            excerpt:
            ...
            image:
              "https://coronadotimes.com/wp-content/uploads/2024/04/A-report-card-Excellence-green.jpg",
          ...
          {
            title:
              "Why 500+ Schools Switched to Automated Timetable Generation This Year",
            excerpt:
            ...
            image:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSimBhMmZWyoCS8J6lh2x0rqZP73RmnPLiPpQ&s",
          ...
          {
            title:
              "FERPA, COPPA & Beyond: A School Admin's Guide to Student Data Privacy in 2026",
            excerpt:
            ...
            image:
              "https://framerusercontent.com/images/6IN8y0vjF6g1QOqCmlATuRxHQ.jpg?width=4096&height=2304",
          ...
          {
            title:
              "How to Launch a Successful Parent Communication Portal in Under 2 Weeks",
            excerpt:
            ...
            image:
              "https://www.growthengineering.co.uk/wp-content/uploads/2024/10/Evo-of-Learning-Tech-ills_Hero.png",
...
>>>>>>> 0d3d65ddb422d4f6abece8f70a1f6cd48635b63d
      ...
      <Trending
        ...
        posts={[
          {
            title:
              "How AI-Powered Attendance Systems Are Reducing Truancy by 40%",
            href: `${ROUTES.marketing.blog}/ai-attendance-reducing-truancy`,
            category: "Attendance & Safety",
            date: "Feb 10, 2026",
            readTime: "8 min read",
        ...
        topics={[
          {
            ...
            count: 17,
            href: `${ROUTES.marketing.blog}/topics/attendance-automation`,
            size: "lg",
          },
          {
            label: "Fee Collection",
            count: 14,
            href: `${ROUTES.marketing.blog}/topics/fee-collection`,
            size: "lg",
          },
          {
            label: "Report Cards",
            count: 12,
            href: `${ROUTES.marketing.blog}/topics/report-cards`,
            size: "md",
          },
          {
            label: "Parent Portal",
            count: 11,
            href: `${ROUTES.marketing.blog}/topics/parent-portal`,
            size: "md",
          },
          {
            label: "Timetable Management",
            count: 9,
            href: `${ROUTES.marketing.blog}/topics/timetable-management`,
            size: "md",
          },
          {
            label: "Student Safety",
            count: 8,
            href: `${ROUTES.marketing.blog}/topics/student-safety`,
            size: "md",
          },
          {
            label: "Exam Management",
            count: 10,
            href: `${ROUTES.marketing.blog}/topics/exam-management`,
            size: "md",
          },
          {
            label: "Staff Onboarding",
            count: 6,
            href: `${ROUTES.marketing.blog}/topics/staff-onboarding`,
            size: "sm",
          },
          {
            label: "Data Analytics",
            count: 13,
            href: `${ROUTES.marketing.blog}/topics/data-analytics`,
            size: "lg",
          },
          {
            label: "FERPA Compliance",
            count: 5,
            href: `${ROUTES.marketing.blog}/topics/ferpa-compliance`,
            size: "sm",
          },
          {
            label: "Digital Classrooms",
            count: 15,
            href: `${ROUTES.marketing.blog}/topics/digital-classrooms`,
            size: "lg",
          },
          {
            label: "SMS & Notifications",
            count: 7,
            href: `${ROUTES.marketing.blog}/topics/sms-notifications`,
            size: "sm",
          },
          {
            label: "School ERP",
            count: 11,
            href: `${ROUTES.marketing.blog}/topics/school-erp`,
            size: "md",
          },
          {
            label: "Admissions",
            count: 8,
            href: `${ROUTES.marketing.blog}/topics/admissions`,
            size: "md",
          },
          {
            label: "Transport Management",
            count: 4,
            href: `${ROUTES.marketing.blog}/topics/transport-management`,
            size: "sm",
          },
          {
            label: "Library Management",
            count: 5,
            href: `${ROUTES.marketing.blog}/topics/library-management`,
            size: "sm",
          },
          {
            label: "Teacher Training",
            count: 7,
            href: `${ROUTES.marketing.blog}/topics/teacher-training`,
            size: "sm",
          },
          {
            label: "Budget Planning",
            count: 6,
            href: `${ROUTES.marketing.blog}/topics/budget-planning`,
            size: "sm",
          },
        ]}
      />
