...
export const metadata: Metadata = {
	title: "Features — Comprehensive School Management Platform | EduPortal ",
	description:
		"Explore the complete suite of EduPortal features: automated attendance tracking, digital gradebooks, parent-teacher communication, fee management, analytics dashboards, and more — built for modern K-12 schools.",
	keywords: [
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: "EduPortal Features Overview",
			},
		],
	},
	twitter: {
	...
	return (
		<>
			...
			<Hero
				...
				description="From automated attendance tracking and digital gradebooks to seamless parent communication and real-time analytics — EduPortal replaces dozens of disconnected tools with one unified platform trusted by 2,500+ schools."
				cta={{
			...
			<Attendance
				...
				image={{
					...
					alt: "EduPortal attendance tracking dashboard showing real-time student check-in status",
				}}
				highlights={[
					{
						icon: QrCode,
			...
			<Gradebook
				...
				image={{
					...
					alt: "EduPortal digital gradebook interface with student performance charts and grade entry",
				}}
				highlights={[
					{
						icon: BookOpen,
			...
			<Communication
				...
				image={{
					...
					alt: "EduPortal communication dashboard showing parent-teacher messaging and broadcast notifications",
				}}
				highlights={[
					{
						icon: Mail,
			...
			<Reporting
				...
				image={{
					...
					alt: "EduPortal analytics dashboard with attendance trends, academic performance charts, and financial reports",
				}}
				highlights={[
					{
			...
			<Administration
				...
				image={{
					...
					alt: "EduPortal admin panel showing student enrollment, staff management, and transport routing",
				}}
				highlights={[
					{
						icon: School,
			...
			<MobileApp
				...
				description="Give teachers, parents, and administrators instant access to every feature from their smartphones. The EduPortal mobile app delivers real-time updates, quick actions, and full functionality — no desktop required."
				features={[
					{
						icon: CalendarCheck,
			...
			<IntegrationsPreview
				...
				subtitle="EduPortal integrates seamlessly with popular education platforms, payment gateways, communication tools, and government portals — so your school ecosystem works as one."
				integrations={[
					{
			...
			<CTA
				...
				description="Join 2,500+ schools that have eliminated paperwork, improved parent engagement by 85%, and saved 20+ hours per week with EduPortal . Start your free 30-day trial today — no credit card required."
