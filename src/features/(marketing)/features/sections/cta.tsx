...
{primary.text}
        ...
        {secondary && (
            <Button size="lg" variant="outline" className="rounded-full px-8 border-primary-foreground/30 text-secondary hover:text-secondary hover:bg-destructive/10" href={secondary.href}>{secondary.text}            </Button>
        )}
    </div>
);
