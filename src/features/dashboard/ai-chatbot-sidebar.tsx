...
export default function AiChatbotSidebar({ open, setOpen }: { open: boolean; setOpen: (open: boolean) => void }) {
    ...
    return (
        <div className="fixed bottom-4 left-4 right-4 @md:left-auto @md:right-6 @md:bottom-6 @md:max-w-sm @md:w-full z-40">            <aside className="bg-card/95 border-border/70 outline shadow-lg supports-backdrop-filter:bg-card/85 flex h-[min(78vh,680px)]  flex-col overflow-hidden rounded-2xl border backdrop-blur">
